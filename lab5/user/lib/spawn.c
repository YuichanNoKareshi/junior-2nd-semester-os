				  ...
				  s32 aff)
{
...

	{
		 ...
		 *  You do not need to modify code in this scope
		 */
		pmo_requests[0].size = MAIN_THREAD_STACK_SIZE; //LAB4_SPAWN_BLANK
		pmo_requests[0].type = PMO_DATA; //LAB4_SPAWN_BLANK
...

	{
		 ...
		 * that address.
		 */
		stack_top = MAIN_THREAD_STACK_BASE + MAIN_THREAD_STACK_SIZE; //LAB4_SPAWN_BLANK
		stack_offset = MAIN_THREAD_STACK_SIZE - PAGE_SIZE; //LAB4_SPAWN_BLANK
...

	{
		 ...
		 */
		pmo_map_requests[0].pmo_cap = main_stack_cap; //LAB4_SPAWN_BLANK
		pmo_map_requests[0].addr = MAIN_THREAD_STACK_BASE; //LAB4_SPAWN_BLANK
		pmo_map_requests[0].perm = VM_READ | VM_WRITE; //LAB4_SPAWN_BLANK
...

	{
		 ...
		 */
		stack_va = MAIN_THREAD_STACK_BASE + MAIN_THREAD_STACK_SIZE - PAGE_SIZE; //LAB4_SPAWN_BLANK
		main_thread_cap =
